...
import L5_GUI.data.PublishingHouse;
...
public class MainWindow extends JFrame {
    ...
    private void initComponents() {
        ...
        myTableModel = new MyTableModel(new PublishingHouse());
        jTable.setModel(myTableModel);
